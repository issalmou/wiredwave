...
export default function Laoding() {
  return (
    ...
    <div className="styles.preloader">
          <svg className="cart" id='cart' role="img" aria-label="Shopping cart line animation" viewBox="0 0 128 128" width="128px" height="128px" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="preloader__text">
            <p className="preloader__msg">Please wait…</p>
